-- Day 9 canonical content reference DDL.
-- Design artifact only. Do not apply as a production migration unchanged.
-- ingest and staging are defined by the Day 7 reference DDL.
