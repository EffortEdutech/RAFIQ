---
artifact_id: "vault:governance:provenance:source_snapshot:qul-day4-topics-public-evidence:manifest"
artifact_type: "release_gate_pack"
title: "Governance Pack - source_snapshot qul-day4-topics-public-evidence manifest provenance"
status: "generated"
...
canonical_refs: ["manifest:source_manifest:data/manifests/qul-day4-topics-public-evidence.json"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:qul", "snapshot:qul-day4-topics-public-evidence"]
graph_node_ids: ["provenance:source_snapshot:qul-day4-topics-public-evidence:manifest"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Governance Pack - source_snapshot qul-day4-topics-public-evidence manifest provenance

## Summary

Private governance pack for `provenance:source_snapshot:qul-day4-topics-public-evidence:manifest`.
...
- manifest:source_manifest:data/manifests/qul-day4-topics-public-evidence.json
...
| --- | --- | --- | --- | --- | --- |
| provenance:source_snapshot:qul-day4-topics-public-evidence:manifest | entity_provenance | governance | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| entityType | "source_snapshot" |
| entityId | "qul-day4-topics-public-evidence" |
| stagingTable | null |
| stagingId | null |
| sourceSnapshotId | "qul-day4-topics-public-evidence" |
| mappingMethod | "manifest_backbone_export" |
| manifestPath | "data/manifests/qul-day4-topics-public-evidence.json" |
| sourceManifestChecksumSha256 | "3EB7A87B03325E6E5193804464387B3970371CDF83D79238BB11A1F8CE0C835D" |
