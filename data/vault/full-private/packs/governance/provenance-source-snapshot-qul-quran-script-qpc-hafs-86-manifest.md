---
artifact_id: "vault:governance:provenance:source_snapshot:qul-quran-script-qpc-hafs-86:manifest"
artifact_type: "release_gate_pack"
title: "Governance Pack - source_snapshot qul-quran-script-qpc-hafs-86 manifest provenance"
status: "generated"
...
canonical_refs: ["manifest:source_manifest:data/manifests/qul-quran-script-qpc-hafs-86.json"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:qul", "snapshot:qul-quran-script-qpc-hafs-86"]
graph_node_ids: ["provenance:source_snapshot:qul-quran-script-qpc-hafs-86:manifest"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Governance Pack - source_snapshot qul-quran-script-qpc-hafs-86 manifest provenance

## Summary

Private governance pack for `provenance:source_snapshot:qul-quran-script-qpc-hafs-86:manifest`.
...
- manifest:source_manifest:data/manifests/qul-quran-script-qpc-hafs-86.json
...
| --- | --- | --- | --- | --- | --- |
| provenance:source_snapshot:qul-quran-script-qpc-hafs-86:manifest | entity_provenance | governance | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| entityType | "source_snapshot" |
| entityId | "qul-quran-script-qpc-hafs-86" |
| stagingTable | null |
| stagingId | null |
| sourceSnapshotId | "qul-quran-script-qpc-hafs-86" |
| mappingMethod | "manifest_backbone_export" |
| manifestPath | "data/manifests/qul-quran-script-qpc-hafs-86.json" |
| sourceManifestChecksumSha256 | "3C99D5A01494BEA62004941EED8275C884B67D96DFF22148580F0CB6DC0660F3" |
