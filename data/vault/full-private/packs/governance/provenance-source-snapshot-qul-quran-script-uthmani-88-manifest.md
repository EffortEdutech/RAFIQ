---
artifact_id: "vault:governance:provenance:source_snapshot:qul-quran-script-uthmani-88:manifest"
artifact_type: "release_gate_pack"
title: "Governance Pack - source_snapshot qul-quran-script-uthmani-88 manifest provenance"
status: "generated"
...
canonical_refs: ["manifest:source_manifest:data/manifests/qul-quran-script-uthmani-88.json"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:qul", "snapshot:qul-quran-script-uthmani-88"]
graph_node_ids: ["provenance:source_snapshot:qul-quran-script-uthmani-88:manifest"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Governance Pack - source_snapshot qul-quran-script-uthmani-88 manifest provenance

## Summary

Private governance pack for `provenance:source_snapshot:qul-quran-script-uthmani-88:manifest`.
...
- manifest:source_manifest:data/manifests/qul-quran-script-uthmani-88.json
...
| --- | --- | --- | --- | --- | --- |
| provenance:source_snapshot:qul-quran-script-uthmani-88:manifest | entity_provenance | governance | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| entityType | "source_snapshot" |
| entityId | "qul-quran-script-uthmani-88" |
| stagingTable | null |
| stagingId | null |
| sourceSnapshotId | "qul-quran-script-uthmani-88" |
| mappingMethod | "manifest_backbone_export" |
| manifestPath | "data/manifests/qul-quran-script-uthmani-88.json" |
| sourceManifestChecksumSha256 | "74B3267FE6594B5A0897A285214331428BCD667FCA81CE0D3C43AB7F9394267D" |
