---
artifact_id: "vault:quality:quality_finding:category:collections"
artifact_type: "release_gate_pack"
title: "Quality Pack - Hadith collections acquisition category finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:category:collections"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:hadith-category:hadith", "snapshot:hadith-resource:hadith_collections", "provenance:source_snapshot:hadith-resource:hadith_collections:manifest", "release_state:source_snapshot:hadith-resource:hadith_collections:manifest"]
graph_node_ids: ["quality_finding:category:collections"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Hadith collections acquisition category finding

## Summary

Private quality/remediation pack for `quality_finding:category:collections`.
...
- data:hadith_quality_inventory:category:collections

## Source And Attribution

- graph_manifest:rafiq-full-private-resource-graph
- source:hadith-category:hadith
- snapshot:hadith-resource:hadith_collections
- provenance:source_snapshot:hadith-resource:hadith_collections:manifest
- release_state:source_snapshot:hadith-resource:hadith_collections:manifest

## Evidence Graph

Graph node IDs:

- quality_finding:category:collections

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:category:collections | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_acquisition_category" |
| targetId | "hadith_collection:collections:category-summary" |
| findingCode | "hadith_category_inventory_status" |
| severity | "warning" |
| resolutionStatus | "open" |
| category | "collections" |
| resourceDirectories | 9 |
| fileCount | 653047 |
| bytes | 4301718931 |
