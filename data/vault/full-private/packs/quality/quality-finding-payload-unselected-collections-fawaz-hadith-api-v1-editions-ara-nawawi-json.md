---
artifact_id: "vault:quality:quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json"
artifact_type: "release_gate_pack"
title: "Quality Pack - Collections Fawaz Hadith Api V1 Editions Ara Nawawi Json payload unselected finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:payload-unselected:collections/fawaz-hadith-api-v1/editions/ara-nawawi.json"]
...
graph_node_ids: ["quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Collections Fawaz Hadith Api V1 Editions Ara Nawawi Json payload unselected finding

## Summary

Private quality/remediation pack for `quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json`.
...
- data:hadith_quality_inventory:payload-unselected:collections/fawaz-hadith-api-v1/editions/ara-nawawi.json
...
- quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_record" |
| targetId | "hadith_record:collections_fawaz-hadith-api-v1_editions_ara-nawawi.json:aggregate" |
| findingCode | "payload_unselected_in_raw_inventory" |
| severity | "warning" |
| resolutionStatus | "requires_parser_review" |
| groupKey | "collections/fawaz-hadith-api-v1/editions/ara-nawawi.json" |
| roleCounts | {"payload_unselected":1} |
| aggregateSha256 | "DFE1FC556D4FD27833186E7EB8040441778B40210D962EBF159A876D4894A7C3" |
