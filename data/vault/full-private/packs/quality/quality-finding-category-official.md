---
artifact_id: "vault:quality:quality_finding:category:official"
artifact_type: "release_gate_pack"
title: "Quality Pack - Hadith official acquisition category finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:category:official"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:hadith-category:hadith", "snapshot:hadith-resource:hadith_official", "provenance:source_snapshot:hadith-resource:hadith_official:manifest", "release_state:source_snapshot:hadith-resource:hadith_official:manifest"]
graph_node_ids: ["quality_finding:category:official"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Hadith official acquisition category finding

## Summary

Private quality/remediation pack for `quality_finding:category:official`.
...
- data:hadith_quality_inventory:category:official

## Source And Attribution

- graph_manifest:rafiq-full-private-resource-graph
- source:hadith-category:hadith
- snapshot:hadith-resource:hadith_official
- provenance:source_snapshot:hadith-resource:hadith_official:manifest
- release_state:source_snapshot:hadith-resource:hadith_official:manifest

## Evidence Graph

Graph node IDs:

- quality_finding:category:official

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:category:official | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_acquisition_category" |
| targetId | "hadith_collection:official:category-summary" |
