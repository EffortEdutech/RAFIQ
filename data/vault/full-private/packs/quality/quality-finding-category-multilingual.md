---
artifact_id: "vault:quality:quality_finding:category:multilingual"
artifact_type: "release_gate_pack"
title: "Quality Pack - Hadith multilingual acquisition category finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:category:multilingual"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:hadith-category:hadith", "snapshot:hadith-resource:hadith_multilingual", "provenance:source_snapshot:hadith-resource:hadith_multilingual:manifest", "release_state:source_snapshot:hadith-resource:hadith_multilingual:manifest"]
graph_node_ids: ["quality_finding:category:multilingual"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Hadith multilingual acquisition category finding

## Summary

Private quality/remediation pack for `quality_finding:category:multilingual`.
...
- data:hadith_quality_inventory:category:multilingual

## Source And Attribution

- graph_manifest:rafiq-full-private-resource-graph
- source:hadith-category:hadith
- snapshot:hadith-resource:hadith_multilingual
- provenance:source_snapshot:hadith-resource:hadith_multilingual:manifest
- release_state:source_snapshot:hadith-resource:hadith_multilingual:manifest

## Evidence Graph

Graph node IDs:

- quality_finding:category:multilingual

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:category:multilingual | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_acquisition_category" |
| targetId | "hadith_collection:multilingual:category-summary" |
| findingCode | "hadith_category_inventory_status" |
| severity | "warning" |
| resolutionStatus | "open" |
| category | "multilingual" |
| resourceDirectories | 3 |
| fileCount | 113 |
| bytes | 229021537 |
