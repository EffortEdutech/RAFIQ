---
artifact_id: "vault:quality:quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json"
artifact_type: "release_gate_pack"
title: "Quality Pack - Collections Fawaz Hadith Api V1 Editions Ara Dehlawi Json payload unselected finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:payload-unselected:collections/fawaz-hadith-api-v1/editions/ara-dehlawi.json"]
...
graph_node_ids: ["quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Collections Fawaz Hadith Api V1 Editions Ara Dehlawi Json payload unselected finding

## Summary

Private quality/remediation pack for `quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json`.
...
- data:hadith_quality_inventory:payload-unselected:collections/fawaz-hadith-api-v1/editions/ara-dehlawi.json
...
- quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:payload-unselected:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_record" |
| targetId | "hadith_record:collections_fawaz-hadith-api-v1_editions_ara-dehlawi.json:aggregate" |
| findingCode | "payload_unselected_in_raw_inventory" |
| severity | "warning" |
| resolutionStatus | "requires_parser_review" |
| groupKey | "collections/fawaz-hadith-api-v1/editions/ara-dehlawi.json" |
| roleCounts | {"payload_unselected":1} |
| aggregateSha256 | "EBC64F10E5EC399BB295515B474D85F01D163A38DE627679E92C58C8F97AEE82" |
