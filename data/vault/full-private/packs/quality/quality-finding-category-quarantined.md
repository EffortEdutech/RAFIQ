---
artifact_id: "vault:quality:quality_finding:category:quarantined"
artifact_type: "release_gate_pack"
title: "Quality Pack - Hadith quarantined acquisition category finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:category:quarantined"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:hadith-category:hadith", "snapshot:hadith-resource:hadith_quarantined", "provenance:source_snapshot:hadith-resource:hadith_quarantined:manifest", "release_state:source_snapshot:hadith-resource:hadith_quarantined:manifest"]
graph_node_ids: ["quality_finding:category:quarantined"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "withheld"
---

# Quality Pack - Hadith quarantined acquisition category finding

## Summary

Private quality/remediation pack for `quality_finding:category:quarantined`.
...
- data:hadith_quality_inventory:category:quarantined

## Source And Attribution

- graph_manifest:rafiq-full-private-resource-graph
- source:hadith-category:hadith
- snapshot:hadith-resource:hadith_quarantined
- provenance:source_snapshot:hadith-resource:hadith_quarantined:manifest
- release_state:source_snapshot:hadith-resource:hadith_quarantined:manifest

## Evidence Graph

Graph node IDs:

- quality_finding:category:quarantined

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:category:quarantined | validation_finding | quality | public_blocked | technical_review | withheld |

| Field | Value |
| --- | --- |
| targetType | "hadith_acquisition_category" |
| targetId | "hadith_collection:quarantined:category-summary" |
| findingCode | "hadith_category_inventory_status" |
| severity | "withheld" |
| resolutionStatus | "open" |
| category | "quarantined" |
| resourceDirectories | 4 |
| fileCount | 783 |
| bytes | 305833829 |
