---
artifact_id: "vault:quality:quality_finding:category:grades"
artifact_type: "release_gate_pack"
title: "Quality Pack - Hadith grades acquisition category finding"
status: "generated"
...
canonical_refs: ["data:hadith_quality_inventory:category:grades"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source:hadith-category:hadith", "snapshot:hadith-resource:hadith_grades", "provenance:source_snapshot:hadith-resource:hadith_grades:manifest", "release_state:source_snapshot:hadith-resource:hadith_grades:manifest"]
graph_node_ids: ["quality_finding:category:grades"]
release_state: "public_blocked"
review_state: "technical_review"
quality_state: "warning"
---

# Quality Pack - Hadith grades acquisition category finding

## Summary

Private quality/remediation pack for `quality_finding:category:grades`.
...
- data:hadith_quality_inventory:category:grades

## Source And Attribution

- graph_manifest:rafiq-full-private-resource-graph
- source:hadith-category:hadith
- snapshot:hadith-resource:hadith_grades
- provenance:source_snapshot:hadith-resource:hadith_grades:manifest
- release_state:source_snapshot:hadith-resource:hadith_grades:manifest

## Evidence Graph

Graph node IDs:

- quality_finding:category:grades

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| quality_finding:category:grades | validation_finding | quality | public_blocked | technical_review | warning |

| Field | Value |
| --- | --- |
| targetType | "hadith_acquisition_category" |
| targetId | "hadith_collection:grades:category-summary" |
