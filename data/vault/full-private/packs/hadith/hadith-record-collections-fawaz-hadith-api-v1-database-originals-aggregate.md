---
artifact_id: "vault:hadith:hadith_record:collections_fawaz-hadith-api-v1_database_originals:aggregate"
artifact_type: "hadith_verification_pack"
title: "Hadith Pack - Collections Fawaz Hadith Api V1 Database Originals aggregate record"
status: "generated"
...
canonical_refs: ["data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/database/originals:record"]
...
graph_node_ids: ["hadith_record:collections_fawaz-hadith-api-v1_database_originals:aggregate"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Hadith Pack - Collections Fawaz Hadith Api V1 Database Originals aggregate record

## Summary

Private hadith verification pack for `hadith_record:collections_fawaz-hadith-api-v1_database_originals:aggregate`.
...
- data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/database/originals:record
...
- hadith_record:collections_fawaz-hadith-api-v1_database_originals:aggregate

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| hadith_record:collections_fawaz-hadith-api-v1_database_originals:aggregate | hadith_record | hadith | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| editionId | "collections_fawaz-hadith-api-v1" |
| sourceHadithKey | "collections_fawaz-hadith-api-v1_database_originals:aggregate" |
| sourceHadithNumber | null |
| printedReference | "collections/fawaz-hadith-api-v1/database/originals" |
| aggregateOnly | true |
| representedPrincipalFiles | 29 |
| representedBytes | 461590799 |
