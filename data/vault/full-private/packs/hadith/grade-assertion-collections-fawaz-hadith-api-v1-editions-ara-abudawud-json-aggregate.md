---
artifact_id: "vault:hadith:grade_assertion:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate"
artifact_type: "hadith_verification_pack"
title: "Hadith Pack - Collections Fawaz Hadith Api V1 Editions Ara Abudawud Json source grade assertion"
status: "generated"
...
canonical_refs: ["data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/editions/ara-abudawud.json:grade"]
...
graph_node_ids: ["grade_assertion:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate"]
release_state: "public_blocked"
review_state: "content_review"
quality_state: "warning"
---

# Hadith Pack - Collections Fawaz Hadith Api V1 Editions Ara Abudawud Json source grade assertion

## Summary

Private hadith verification pack for `grade_assertion:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate`.
...
- data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/editions/ara-abudawud.json:grade
...
- grade_assertion:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| grade_assertion:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate | hadith_grade_assertion | hadith-grades | public_blocked | content_review | warning |

| Field | Value |
| --- | --- |
| hadithRecordId | "hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.json:aggregate" |
