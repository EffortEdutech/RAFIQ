---
artifact_id: "vault:hadith:hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate"
artifact_type: "hadith_verification_pack"
title: "Hadith Pack - Collections Fawaz Hadith Api V1 Editions Ara Abudawud Min Json aggregate record"
status: "generated"
...
canonical_refs: ["data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/editions/ara-abudawud.min.json:record"]
...
graph_node_ids: ["hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Hadith Pack - Collections Fawaz Hadith Api V1 Editions Ara Abudawud Min Json aggregate record

## Summary

Private hadith verification pack for `hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate`.
...
- data:hadith_raw_subtrees:collections/fawaz-hadith-api-v1/editions/ara-abudawud.min.json:record
...
- hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| hadith_record:collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate | hadith_record | hadith | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| editionId | "collections_fawaz-hadith-api-v1" |
| sourceHadithKey | "collections_fawaz-hadith-api-v1_editions_ara-abudawud.min.json:aggregate" |
| sourceHadithNumber | null |
| printedReference | "collections/fawaz-hadith-api-v1/editions/ara-abudawud.min.json" |
| aggregateOnly | true |
| representedPrincipalFiles | 1 |
| representedBytes | 6623115 |
