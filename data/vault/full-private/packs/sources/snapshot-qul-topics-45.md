---
artifact_id: "vault:source:snapshot:qul-topics-45"
artifact_type: "source_approval_pack"
title: "Source Pack - QUL Topics and Concepts"
status: "generated"
...
canonical_refs: ["ingest:source_snapshots:qul-topics-45"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source_manifest", "provenance:source_snapshot:qul-topics-45:manifest", "release_state:source_snapshot:qul-topics-45:manifest"]
graph_node_ids: ["snapshot:qul-topics-45"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "clean"
---

# Source Pack - QUL Topics and Concepts

## Summary

Private source approval pack for `snapshot:qul-topics-45`.
...
- ingest:source_snapshots:qul-topics-45
...
| --- | --- | --- | --- | --- | --- |
| snapshot:qul-topics-45 | source_snapshot | sources | public_blocked | pending | clean |

| Field | Value |
| --- | --- |
| sourceId | "qul" |
| snapshotKey | "qul-topics-45" |
...
| attribution | "Composite QUL topic resource with upstream Quranic Arabic Corpus and The Clear Quran attribution; complete per-namespace rights remain unresolved" |
