---
artifact_id: "vault:source:source:qul"
artifact_type: "source_approval_pack"
title: "Source Pack - Quranic Universal Library resources"
status: "generated"
...
canonical_refs: ["ingest:source_registry:qul"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph"]
graph_node_ids: ["source:qul"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "unverified"
---

# Source Pack - Quranic Universal Library resources

## Summary

Private source approval pack for `source:qul`.
...
| --- | --- | --- | --- | --- | --- |
| source:qul | source | sources | public_blocked | pending | unverified |

| Field | Value |
| --- | --- |
| sourceKey | "qul" |
| name | "Quranic Universal Library resources" |
| provider | "TarteelAI / QUL" |
| domain | "ayah_theme" |
