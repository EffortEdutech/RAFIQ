---
artifact_id: "vault:source:snapshot:qul-translation-malay-292"
artifact_type: "source_approval_pack"
title: "Source Pack - QUL Abdullah Basamia Malay Translation"
status: "generated"
...
canonical_refs: ["ingest:source_snapshots:qul-translation-malay-292"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source_manifest", "provenance:source_snapshot:qul-translation-malay-292:manifest", "release_state:source_snapshot:qul-translation-malay-292:manifest"]
graph_node_ids: ["snapshot:qul-translation-malay-292"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "clean"
---

# Source Pack - QUL Abdullah Basamia Malay Translation

## Summary

Private source approval pack for `snapshot:qul-translation-malay-292`.
...
- ingest:source_snapshots:qul-translation-malay-292
...
| --- | --- | --- | --- | --- | --- |
| snapshot:qul-translation-malay-292 | source_snapshot | sources | public_blocked | pending | clean |

| Field | Value |
| --- | --- |
| sourceId | "qul" |
| snapshotKey | "qul-translation-malay-292" |
| versionLabel | "2026-06-12" |
| acquiredAt | "2026-06-12" |
| rightsStatus | "blocked_or_pending" |
| attributionStatus | "blocked_or_pending" |
| technicalStatus | "raw_validated_rights_and_attribution_blocked" |
| publicationStatus | "public_blocked" |
| officialUrl | "https://qul.tarteel.ai/resources/translation/292" |
| licenseUrl | "https://qul.tarteel.ai/resources/292/copyright" |
