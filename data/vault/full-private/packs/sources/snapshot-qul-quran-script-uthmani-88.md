---
artifact_id: "vault:source:snapshot:qul-quran-script-uthmani-88"
artifact_type: "source_approval_pack"
title: "Source Pack - QUL Uthmani Ayah by Ayah"
status: "generated"
...
canonical_refs: ["ingest:source_snapshots:qul-quran-script-uthmani-88"]
source_refs: ["graph_manifest:rafiq-full-private-resource-graph", "source_manifest", "provenance:source_snapshot:qul-quran-script-uthmani-88:manifest", "release_state:source_snapshot:qul-quran-script-uthmani-88:manifest"]
graph_node_ids: ["snapshot:qul-quran-script-uthmani-88"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "clean"
---

# Source Pack - QUL Uthmani Ayah by Ayah

## Summary

Private source approval pack for `snapshot:qul-quran-script-uthmani-88`.
...
- ingest:source_snapshots:qul-quran-script-uthmani-88
...
| --- | --- | --- | --- | --- | --- |
| snapshot:qul-quran-script-uthmani-88 | source_snapshot | sources | public_blocked | pending | clean |

| Field | Value |
| --- | --- |
| sourceId | "qul" |
| snapshotKey | "qul-quran-script-uthmani-88" |
...
| officialUrl | "https://qul.tarteel.ai/resources/quran-script/88" |
| licenseUrl | "https://qul.tarteel.ai/resources/88/copyright" |
