---
artifact_id: "vault:source:raw_object:qul-day4-tafsir-public-evidence:principal"
artifact_type: "source_approval_pack"
title: "Source Pack - data/raw/day4/qul-evidence/"
status: "generated"
...
canonical_refs: ["ingest:raw_objects:qul-day4-tafsir-public-evidence:principal"]
...
graph_node_ids: ["raw_object:qul-day4-tafsir-public-evidence:principal"]
release_state: "private_available"
review_state: "pending"
quality_state: "unverified"
---

# Source Pack - data/raw/day4/qul-evidence/

## Summary

Private source approval pack for `raw_object:qul-day4-tafsir-public-evidence:principal`.
...
- ingest:raw_objects:qul-day4-tafsir-public-evidence:principal
...
- raw_object:qul-day4-tafsir-public-evidence:principal

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| raw_object:qul-day4-tafsir-public-evidence:principal | raw_object | sources | private_available | pending | unverified |

| Field | Value |
| --- | --- |
| snapshotId | "qul-day4-tafsir-public-evidence" |
| objectRole | "principal" |
| logicalName | "QUL Tafsir Public Schema Evidence" |
| pathOrObjectKey | "data/raw/day4/qul-evidence/" |
| checksumSha256 | "" |
| byteLength | null |
| mediaType | "HTML audit evidence; advertised dataset formats are JSON and SQLite" |
