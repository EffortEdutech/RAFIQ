---
artifact_id: "vault:source:raw_object:qul-tafsir-english-ibn-kathir-35:principal"
artifact_type: "source_approval_pack"
title: "Source Pack - data/raw/tafsir/en-tafisr-ibn-kathir.json"
status: "generated"
...
canonical_refs: ["ingest:raw_objects:qul-tafsir-english-ibn-kathir-35:principal"]
...
graph_node_ids: ["raw_object:qul-tafsir-english-ibn-kathir-35:principal"]
release_state: "public_blocked"
review_state: "pending"
quality_state: "clean"
---

# Source Pack - data/raw/tafsir/en-tafisr-ibn-kathir.json

## Summary

Private source approval pack for `raw_object:qul-tafsir-english-ibn-kathir-35:principal`.
...
- ingest:raw_objects:qul-tafsir-english-ibn-kathir-35:principal
...
- raw_object:qul-tafsir-english-ibn-kathir-35:principal

| Node ID | Type | Partition | Release | Review | Quality |
| --- | --- | --- | --- | --- | --- |
| raw_object:qul-tafsir-english-ibn-kathir-35:principal | raw_object | sources | public_blocked | pending | clean |

| Field | Value |
| --- | --- |
| snapshotId | "qul-tafsir-english-ibn-kathir-35" |
| objectRole | "principal" |
| logicalName | "QUL English Tafsir Ibn Kathir" |
| pathOrObjectKey | "data/raw/tafsir/en-tafisr-ibn-kathir.json" |
| checksumSha256 | "F0DA06E9DA263CDB1C5914FBFF4991AF53A736D8F21DEFE1B3C405767565D0AB" |
| byteLength | null |
